...
module.exports = {
  ...
  onStart: async function ({ message, args }) {
    ...
    if (!name)
      ...
      try {
        let res = await axios.get(`https://aryan-apis.onrender.com/api/waifu?apikey=aryan`)
      ...
      try {
        let res = await axios.get(`https://aryan-apis.onrender.com/api/waifupic?name=${name}&apikey=aryan`)
